...
const App = () => {
  ...
  }, [accounts, devAuthEnabled]);

  const [messages, setMessages] = useState([
    {
      id: 'welcome',
      sender: 'bot',
      text: 'Welcome to **SlotBot**. Tell me the attendees, time, TV need, room, or participants in any order.'
    }
  ]);
  ...
  /**
   * Makes authenticated requests to the SlotBot backend.
   *
   * IMPORTANT:
   * This requests an access token specifically for the SlotBot API,
   * NOT a Microsoft Graph token.
   */
